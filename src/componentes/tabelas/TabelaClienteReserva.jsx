...
export default function TabelaClienteReserva(props) {
            ...
            <tbody>
                {
                    props.listaItens?.map((item, indice) => {
                        ...
                        return <tr key={indice}>
                            <td>{item.quarto.quarto_codigo}</td>
                            <td>{item.quarto.numero}</td>
                            <td>{item.quarto.andar}</td>
                            <td>{item.quarto.status}</td>
                            <td>{item.quarto.tipoquarto.descricao}</td>
                            <td>
                                <Button onClick={()=>{
                                    const lista = props.listaItens.filter((quarto) => quarto.quarto.quarto_codigo !== item.quarto.quarto_codigo); 
                                    props.setReserva({...props.dadosReserva, quartosReservados:lista});
                                }}>
